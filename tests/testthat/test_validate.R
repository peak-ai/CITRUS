...
test_that("Throw error when too many categorical levels", {
  expect_error(citrus::validate(preprocess_too_many_categories, hyperparameters = hyperparameters_tree), regexp = "Categorical Columns have too many levels: faulty_feature")
})
